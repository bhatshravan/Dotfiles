...
#aliases
	...
	alias configpoly2='mousepad ~/.config/po25.3.1lybar/bar.sh </dev/null >/dev/null 2>&1 & exit'
...
alias sublime='nohup /opt/sublime_text/sublime_text </dev/null >/dev/null 2>&1 &'
